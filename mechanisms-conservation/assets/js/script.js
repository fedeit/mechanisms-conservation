let data = [
    ...
    },
    {
        ...
        "general_info": "The Tinguely Museum in Basel is the premier collection of works by the artist Jean Tinguely, with the authority to certify the authenticity of pieces as Tinguely originals. It also offers conservation/restoration advice and services to both its collection and museums around the world.",
    ...
    },
    {
        ...
        "general_info": "The museum, housed in a former train depot in the center of the city, contains a collection of works by Jean Tinguely, a world-renowned artist that created kinetic sculptures.",
    ...
    let htmlEntry = `<div class="card" style="border-style: solid;margin: 20px 0px;">
        <div class="card-body">
            ...
            <div class="row" id="collapsable-${i}">
                <div class="col">
                    <p class="fw-semibold"><span style="color: rgb(0, 0, 0); background-color: transparent;">General museum information</span></p>
                    <p style="white-space: pre-wrap">${entry.general_info}</p>
                    
                    <p class="fw-semibold"><span style="color: rgb(0, 0, 0); background-color: transparent;">Conservation decision making</span></p>
                    <p style="white-space: pre-wrap">${entry.decision_making}</p>

                    <p class="fw-semibold"><span style="color: rgb(0, 0, 0); background-color: transparent;">Artifact's parts replacement policy</span></p>
                    <p style="white-space: pre-wrap">${entry.replacement_policy}</p>

                    <p class="fw-semibold"><span style="color: rgb(0, 0, 0); background-color: transparent;">Knowledge sharing of conservation methods</span></p>
                    <p style="white-space: pre-wrap">${entry.knowledge_sharing}</p>

                    <p class="fw-semibold"><span style="color: rgb(0, 0, 0); background-color: transparent;">Conservation methods</span></p>
                    <p style="white-space: pre-wrap">${entry.conservation_methods}</p>
                </div>
                <div class="col">
                    <p class="fw-semibold">Preventive conservation strategies<br></p>
                    <p style="white-space: pre-wrap">${entry.preventative_measures}</p>

                    <p class="fw-semibold"><span style="color: rgb(0, 0, 0); background-color: transparent;">Acquisition of artifacts</span></p>
                    <p style="white-space: pre-wrap">${entry.artifact_onboarding}</p>

                    <p class="fw-semibold"><span style="color: rgb(0, 0, 0); background-color: transparent;">Conservation state</span></p>
                    <p style="white-space: pre-wrap">${entry.conservation_states}</p>

                    <p class="fw-semibold"><span style="color: rgb(0, 0, 0); background-color: transparent;">Materials of the artifacts</span></p>
                    <p style="white-space: pre-wrap">${entry.materials}</p>

                    <p class="fw-semibold"><span style="color: rgb(0, 0, 0); background-color: transparent;">Long-term storage and documentation</span></p>
                    <p style="white-space: pre-wrap">${entry.post_restoration}</p>
                    <p><br></p>
                </div>
