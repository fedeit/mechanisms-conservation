...
function searchText() {
    let textQuery = document.getElementById(`text-search`).value
    console.log(textQuery)
    let dataFilter = db.filter( e => {
        console.log(Object.values(e))
        console.log(Object.values(e).indexOf(textQuery))
        return Object.values(e).join().indexOf(textQuery) > -1
    })
    render(dataFilter)
}
